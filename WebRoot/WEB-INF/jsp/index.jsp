...
<html lang="chn">
  	<head>
		...
		<!-- Datepicker -->
		<link href="<%=basePath%>/css/datepicker.css" rel="stylesheet"/>	
  	...
  	<body class="overflow-hidden">
		<div class="wrapper preload">
				...
				<div class="sidebar-inner scrollable-sidebar">
					...
					<div class="content-block">
						<ul class="sidebar-list">
							...
							<li>
								<a href="#" class="clearfix">
									<img src="<%=basePath%>/images/profile/profile5.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
					...
					<div class="content-block">
						<ul class="sidebar-list">
							<li>
								<a href="#" class="clearfix">
									<img src="<%=basePath%>/images/profile/profile6.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="<%=basePath%>/images/profile/profile7.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											Jane Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="<%=basePath%>/images/profile/profile8.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="<%=basePath%>/images/profile/profile9.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								...
								<ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
									<li class="user-avatar">
										<img src="<%=basePath%>/images/profile/profile1.jpg" alt="" class="img-circle">
						...
						<div class="pull-right m-right-sm">
							<div class="user-block hidden-xs">
								<a href="#" id="userToggle" data-toggle="dropdown">
									<img src="<%=basePath%>/images/profile/profile1.jpg" alt="" class="img-circle inline-block user-profile-pic">
									...
									<ul class="dropdown-menu message pull-right">
										...
										<li>
											<a class="clearfix" href="#">
												<img src="<%=basePath%>/images/profile/profile2.jpg" alt="User Avatar">
												<div class="detail">
										...
										<li>
											<a class="clearfix" href="#">
												<img src="<%=basePath%>/images/profile/profile4.jpg" alt="User Avatar">
										...
										<li>
											<a class="clearfix" href="#">
												<img src="<%=basePath%>/images/profile/profile5.jpg" alt="User Avatar">
												<div class="detail">
			...
			<footer class="footer">
				...
				<p class="no-margin">
					&copy; 2014 <strong>后台管理</strong>. ALL Rights Reserved. 
				</p>	
			</footer>
		</div><!-- /wrapper -->
		...
		<!-- Datepicker -->
		<script src='<%=basePath%>/js/uncompressed/datepicker.js'></script>

		<!-- Sparkline -->
		<script src='<%=basePath%>/js/sparkline.min.js'></script>

		<!-- Skycons -->
		<script src='<%=basePath%>/js/uncompressed/skycons.js'></script>
		...
		<!-- Sortable -->
		<script src='<%=basePath%>/js/uncompressed/jquery.sortable.js'></script>
		...
		<script src="<%=basePath%>/js/simplify/simplify_dashboard.js"></script>
